...
const FIELDS: Record<string, FieldDef[]> = {
    ...
    category: [
        { key: 'id', label: 'ID', type: 'readonly' },
        { key: 'tenantId', label: 'Tenant ID', type: 'readonly' },
        { key: 'code', label: 'Code', type: 'text', hint: 'Short unique code (e.g. BEV)' },
        { key: 'name', label: 'Name (TH)', type: 'text' },
        { key: 'nameEn', label: 'Name (EN)', type: 'text' },
        { key: 'color', label: 'Color', type: 'text', hint: 'CSS color e.g. #ff6600' },
    ...
    diningtable: [
        ...
        { key: 'name', label: 'Table Name', type: 'text', hint: 'Display name e.g. A1' },
        { key: 'zone', label: 'Zone', type: 'text', hint: 'Zone name e.g. Indoor, Terrace' },
        { key: 'seats', label: 'Seats', type: 'text' },
        { key: 'status', label: 'Status', type: 'select', options: ['AVAILABLE', 'OCCUPIED', 'RESERVED', 'INACTIVE'] },
        { key: 'isActive', label: 'Active', type: 'boolean' },
    ],
    order: [
        { key: 'id', label: 'ID', type: 'readonly' },
