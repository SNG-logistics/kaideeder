            ...
            <div id="manual-content">
                ...
                <Section title="📋 สารบัญ">
                    <ol style={{ lineHeight: 2, paddingLeft: 24 }}>
                        ...
                        <li>✨ ฟีเจอร์ใหม่: QR Self-Order (v2)</li>
                        <li>✨ ฟีเจอร์ใหม่: จัดการหมวดหมู่และย้ายสินค้า</li>
                    </ol>
                </Section>
                ...
                <Section title="10. การตั้งค่าระบบ (Settings)">
                    <Steps items={[
                        ...
                        'จัดการหมวดหมู่ (/settings/categories) — เพิ่ม/แก้ไขหมวดหมู่, ย้ายสินค้าผิดหมวด',
                        'QR Menu โต๊ะ (/settings/qr) — พิมพ์ QR ติดโต๊ะเพื่อให้ลูกค้าสั่งอาหารเอง',
                        'โปรไฟล์ร้าน — แก้ไขชื่อร้าน โลโก้, สกุลเงินตรา',
                ...
                <Section title="✨ 11. QR Self-Order — ลูกค้าสั่งอาหารเองที่โต๊ะ">
                    <p style={{ lineHeight: 1.8 }}>QR Self-Order ช่วยให้ลูกค้าสั่งอาหารเองผ่านมือถือ โดยไม่ต้องติดตั้งแอปใดๆ</p>
                    <h4 style={{ marginTop: 14 }}>การติดตั้ง (admin/manager):</h4>
                    <Steps items={[
                        'ไปที่ Settings → 📱 QR Menu โต๊ะ',
                        'เห็น QR ตลอดทุกโต๊ะ — กดปุ่ม 🖨️ พิมพ์รายโต๊ะ หรือพิมพ์ทุกโต๊ะพร้อมกัน',
                        'ตัด QR ๑ × ๕ ซม. ติดบนโต๊ะแต่ละตัว',
                    ]} />
                    <h4 style={{ marginTop: 14 }}>Flow ลูกค้า:</h4>
                    <Steps items={[
                        'ลูกค้าสแกน QR ด้วยกล้องมือถือ → เปิดเมนูใน browser (https://kaideeder.com/m/[code]/[table])',
                        'เลือกหมวดหมู่ → เลือกเมนู → กด «+ เพิ่ม» → กด “🍽️ ยืนยันสั่งอาหาร”',
                        'ออเดอร์ขึ้น POS สถานะ “รอยืนยัน”',
                        'แคชเชียร์กด “✅ ยืนยัน” → ออเดอร์เปิด → ครัวรับงาน ✓',
                    ]} />
                    <Note>หากโต๊ะมีออเดอร์ OPEN อยู่แล้ว ระบบจะประคาศแจ้ง “โต๊ะนี้มีออเดอร์อยู่แล้ว กรุณาติดต่อพนักงาน”</Note>
                </Section>

                {/* Section 12 — NEW */}
                <Section title="✨ 12. จัดการหมวดหมู่และย้ายสินค้า">
                    <p style={{ lineHeight: 1.8 }}>เมื่อโหลดข้อมูลสินค้าแล้วบางรายการอาจยังอยู่ผิดหมวดหมู่ (เช่น วัตถุดิบอยู่ในหมวดเมนู) ใช้ฟีเจอร์นี้แก้ไขได้เพียงคลิกเดียว</p>
                    <Steps items={[
                        'ไปที่ Settings → 📂 จัดการหมวดหมู่',
                        'คลิกปุ่ม 📦 (ย้ายสินค้า) ที่หมวดที่ต้องการจัดการ',
                        'กดปุ่ม “⚠️ เลือกผิดประเภทอัตโนมัติ (X)” — ระบบเลือกสินค้าที่ไม่ตรงประเภทให้อัตโนมัติ',
                        'เลือกหมวดหมู่ปลายทางที่ถูกต้อง → กดย้าย ✓',
                    ]} />
                    <Note>บางสินค้าจะมีสัญลักษณ์ “⚠️ ผิดประเภท” สีแดง หมายความว่าสินค้านั้นไม่ว่าจะเป็นวัตถุดิบหรือย้ายใเป็นหมวดเมนู</Note>
                </Section>
